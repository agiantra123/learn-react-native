...
export const insertPeopleData = (peopleJson) => new Promise((resolve, reject) => {
...
export const queryAllPeopleData = () => new Promise((resolve, reject) => {
    Realm.open(databaseOptions)
        .then(realm => {
            let peopleData = realm.objects('people')
            resolve(peopleData)
        })
        .catch((error) => {
            reject(error)
